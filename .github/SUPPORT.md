...
Need help with the Cezzis Cocktails AI Search API? We're here to help! This document provides information about how to get support for the project.
...
If you have questions about using the Cezzis Cocktails AI Search API:

1. **GitHub Discussions** 💬
   - [Start a discussion](https://github.com/mtnvencenzo/cezzis-com-cocktails-aisearch/discussions)
   - Browse existing discussions
   - Best for: General questions, ideas, show-and-tell

2. **GitHub Issues** 🐛
   - [Create an issue](https://github.com/mtnvencenzo/cezzis-com-cocktails-aisearch/issues/new/choose)
